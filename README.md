...
(1) Admins use the [AWS ParallelCluster](https://aws.amazon.com/hpc/parallelcluster/) AWS CloudFormation stack to deploy HPC resources. Resources can reference the network, storage, security, database, and user directory from the previously launched CloudFormation stacks. <br/>
